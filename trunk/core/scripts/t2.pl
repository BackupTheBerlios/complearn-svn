...
my $object = $service->get_object("/org/complearn/CLB");
...
print "complearn_version: " . $object->complearn_version . "\n";
$a = $object->compressor_list();
foreach $b (@$a) {
  print $b."\n";
}
%d = { };
$c = $object->load_compressor("gzip", \%d);
print "c: " . $c . "\n";
$c = $service->get_object($c);
print "c->name: " . $c->name . "\n";
exit 0;
#print "blurb: " . $object->blurb . "\n";
#print "compressor_version: " . $object->compressor_version . "\n";
#print "binding_version: " . $object->binding_version . "\n";
